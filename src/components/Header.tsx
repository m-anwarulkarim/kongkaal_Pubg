      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="hidden sm:inline-block px-3.5 py-1.5 rounded-full text-xs font-bold font-gaming border border-white/20 text-white hover:bg-white/10 transition-colors"
          >
            Login
          </button>
          ...
          <button
            onClick={onRegisterClick}
            className="px-3.5 sm:px-4 py-1.5 rounded-full text-xs font-bold font-gaming bg-[#e50914] text-white hover:bg-red-600 transition-colors shadow-md shadow-red-600/30"
          >
            Register
          </button>
